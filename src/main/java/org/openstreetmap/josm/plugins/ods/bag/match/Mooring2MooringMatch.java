...
public class Mooring2MooringMatch extends MatchImpl<OsmBagMooring, BagMooringParcel> {
    /**
    ...
    public Mooring2MooringMatch(OsmBagMooring osmBagMooring, BagMooringParcel odMooring) {
